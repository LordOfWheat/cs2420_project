...
class list {
    ...
    private:
        ...
        bool searchAll(Node<T> *first, string word);
};
...
template <class T>
bool list<T>::searchAll(string word) {
    return searchAll(this->head, word);
}

template <class T>
bool list<T>::searchAll(Node<T> *first, string word) {
    bool flag;
